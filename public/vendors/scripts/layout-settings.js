(function() {
	...
	$(document).ready(function() {
		...
		var body_light = jQuery('.body-white');

		body_dark.click(function() {
			'use strict';
			jQuery(this).addClass('active');
			body_light.removeClass('active');
			body.removeClass('body-white').addClass('body-dark');
		...
		body_light.click(function() {
			...
			//Store in local storage
			setOptions("bodyBackground", "body-white")
		});

		//Click for current options
		if (currentOptions.bodyBackground === "body-white") {
